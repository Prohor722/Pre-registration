    ...
    <div class="col-md-6">
        ...
        <table class="table">
            ...
            <tr>
                ...
                $query="SELECT * from students WHERE insid='$insid' AND status='h'";
            ...
            foreach ($data as $data_items):
                ...
                <tr>
                    ...
                    <td><a style="text-decoration: none" href="accept_student.php?id=<?= $data_items['uid']?>">
                            <button class="btn btn-primary">Accept</button>
                        </a>

                        <a style="text-decoration: none" href="delete_request.php?id=<?= $data_items['uid']?>">
