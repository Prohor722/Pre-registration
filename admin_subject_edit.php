...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-4" >
            ...
            <form action="admin_subject_update_query.php" method="post">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="sub" class="form-control"
                           value="<?php if(isset($data['sub'])) echo $data['sub']?>" >
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="semester" class="form-control"
                                   value="<?php if(isset($data['semester'])) echo $data['semester']?>" >
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="credit" class="form-control"
                                   value="<?php if(isset($data['credit'])) echo $data['credit']?>" >
                        </div>
                    </div>
                </div>
                <div class="form-group">
