...
<h1 align="center" style="margin-top: 10%">Teacher Login</h1>
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <form method="post" action="teacher_login_error.php"'>
        ...
        <div class="form-group">
            ...
            <button class="btn" style="background-color: #ffad00">
                <a href="teacher_reg.php" style="color: #ffffff; text-decoration: none">Register</a>
            </button>
        </form>
